...
class KDBServer_1 : public rclcpp::Node
{
 public:
     ...
     :Node("KDBServer_1")
     {
         ...
         server_l_srv_srv = this->create_service<racer_interfaces::srv::Serve>("kdbFunc", std::bind(&KDBServer_1::func_l_srv_srv, this, _1, _2));

         server_l_srv_es = this->create_service<racer_interfaces::srv::EdfState>("kdbFunc", std::bind(&KDBServer_1::func_l_srv_es, this, _1, _2));

         server_r_srv_lp = this->create_service<racer_interfaces::srv::LevelPositions>("kdbFunc", std::bind(&KDBServer_1::func_r_srv_lp, this, _1, _2));
