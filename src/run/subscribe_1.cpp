...
class KDBSubscriber_1 : public rclcpp::Node
{
  public:
    ...
    // Creating the Subscriptions
      ...
      "/r_pod/actuate/exhaust", 10, std::bind(&KDBSubscriber_1::callback_r_act_ex, this, _1));

      subscription_l_act_edf=this->create_subscription<racer_interfaces::msg::EdfInput>(
      "/l_pod/actuate/edf", 10, std::bind(&KDBSubscriber_1::callback_l_act_edf, this, _1));

    }
  private:

    void callback_r_act_ex(const racer_interfaces::msg::ExhaustInput::SharedPtr msg) const
    {
    ...
    void callback_l_act_edf(const racer_interfaces::msg::EdfInput::SharedPtr msg) const
    {
    ...
    // Attaching the subscriptions
      ...
      rclcpp::Subscription<racer_interfaces::msg::ExhaustInput>::SharedPtr subscription_r_act_ex;

      rclcpp::Subscription<racer_interfaces::msg::EdfInput>::SharedPtr subscription_l_act_edf;
